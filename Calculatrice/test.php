...
<tr>
<td>X :</td>
<td><input type="text" size="2" value="<?php echo $X;?>"></td>
</tr>
<tr>
<td>Y :</td>
<td><input type="text" size="2" value="<?php echo $Y;?>"></td>
</tr>
<tr>
<td>R :</td>
...
<tr>
<td><input type="submit" value="+" name="operation"></td>
<td><input type="submit" value="-" name="operation"></td>
</tr>
<tr>
<td><input type="submit" value="*" name="operation"></td>
...
<tr>
<td colspan="2"><input type="submit" value="Reset" name="operation"></td>
</tr>
</table>
</form>
</body>
