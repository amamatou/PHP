...
class Mysql
    {
        ...
        //fonction de selection de la base de donnee
        protected function selection_bd()
            {
        ...
        //fonction de deconnexion de la base de donnee
        ...
        public function requete($requete, $p)
            {
        ...
        //fontion qui retourne les donnee dans un tableau grace a fetch array
        public function resultat($p)
            {
                return @mysqli_fetch_array($this->resultat[$p]);
            }

        //fonction permettant de compter le nombre de resultat trouve
        public function nb_resultat($p)
            {
                return @mysqli_num_rows($this->resultat[$p]);
            }
        //function d'affichage des erreur mysql
        public function mysql_erreur()
            {
                if($this->sql_debug == 0)
                    {
